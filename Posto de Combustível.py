...
total_litros = 0
total_arrecadado = 0
mais_40 = 0 #Todos os esses dados partiram do zero para iniciar o que se pede, contagem sempre do zero.

litros = float(input("Digite a quantidade de litros abastecidos (0 para encerrar): ")) #Float para ser numero real (decimal)
...
while litros != 0: #Se litro diferente de 0 => Verdadeiro e continue, se diferente Falso e encerra
    ...
    valor = litros * preco #Valo gasto = litro x preço
...
print("Total arrecadado: R$", total_arrecadado) #Vai extrair dados do somátorio do total de dinjeiro arrecadado
